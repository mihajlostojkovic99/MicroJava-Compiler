...
public class FactorWithActPars extends Factor {

    private Designator Designator;
    private ActParsHelp ActParsHelp;
    private ActPars ActPars;

    public FactorWithActPars (Designator Designator, ActParsHelp ActParsHelp, ActPars ActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorWithActPars(\n");
